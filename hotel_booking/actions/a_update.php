...
if($_POST) {
    ...
    if($picture->error === 0) {
        ...
        $sql = "UPDATE hotel_booking SET room_name='$name', room_type='$type', room_price='$price', room_picture='$picture->fileName' WHERE room_id = $id";
        } else {
            $sql = "UPDATE hotel_booking SET room_name='$name',room_type='$type',room_price='$price' WHERE room_id = $id";
        }
